...
def make_e_to_acc_plot_ts(pred_file, title='', savefolder='', plot_range=(1, 100),
    ...
    if merge_nu_anu is False:
        make_step_plot_e_acc_class('muon-CC', mc_info, nn_pred_correct, axes, plot_range=plot_range, linestyle='-', color='C0')
        make_step_plot_e_acc_class('a_muon-CC', mc_info, nn_pred_correct, axes, plot_range=plot_range, linestyle='--', color='C0')
        make_step_plot_e_acc_class('muon-NC', mc_info, nn_pred_correct, axes, invert=True, plot_range=plot_range, linestyle='-', color='C1')
        make_step_plot_e_acc_class('a_muon-NC', mc_info, nn_pred_correct,axes, invert=True, plot_range=plot_range, linestyle='--', color='C1')
        make_step_plot_e_acc_class('elec-CC', mc_info, nn_pred_correct, axes, invert=True, plot_range=plot_range, linestyle='-', color='C2')
        make_step_plot_e_acc_class('a_elec-CC', mc_info, nn_pred_correct, axes, invert=True, plot_range=plot_range, linestyle='--', color='C2')
        make_step_plot_e_acc_class('elec-NC', mc_info, nn_pred_correct, axes, invert=True, plot_range=plot_range, linestyle='-', color='C3')
        make_step_plot_e_acc_class('a_elec-NC', mc_info, nn_pred_correct, axes, invert=True, plot_range=plot_range, linestyle='--', color='C3')
        make_step_plot_e_acc_class('tau-CC', mc_info, nn_pred_correct, axes, invert=True, plot_range=plot_range, linestyle='-', color='C4')
        make_step_plot_e_acc_class('a_tau-CC', mc_info, nn_pred_correct, axes, invert=True, plot_range=plot_range, linestyle='--', color='C4')
        ...
        be_and_1d_acc_per_e_bin['muon-CC_nu_anu'] = make_step_plot_e_acc_class('muon-CC_nu_anu', mc_info, nn_pred_correct, axes, plot_range=plot_range, linestyle='-', color='C0')
        be_and_1d_acc_per_e_bin['muon-NC_nu_anu'] = make_step_plot_e_acc_class('muon-NC_nu_anu', mc_info, nn_pred_correct, axes, invert=True, plot_range=plot_range, linestyle='-', color='C1')
        be_and_1d_acc_per_e_bin['elec-CC_nu_anu'] = make_step_plot_e_acc_class('elec-CC_nu_anu', mc_info, nn_pred_correct, axes, invert=True, plot_range=plot_range, linestyle='-', color='C2')
        be_and_1d_acc_per_e_bin['elec-NC_nu_anu'] = make_step_plot_e_acc_class('elec-NC_nu_anu', mc_info, nn_pred_correct, axes, invert=True, plot_range=plot_range, linestyle='-', color='C3')
        be_and_1d_acc_per_e_bin['tau-CC_nu_anu'] = make_step_plot_e_acc_class('tau-CC_nu_anu', mc_info, nn_pred_correct, axes, invert=True, plot_range=plot_range, linestyle='-', color='C4')
...
def select_class(class_name, ptype, is_cc, merge_nu_anu=False):
    ...
    """
    particle_types = {'muon-CC': (14, 1),'muon-NC': (14, 0), 'a_muon-CC': (-14, 1), 'a_muon-NC': (-14, 0), 'elec-CC': (12, 1),
                      'a_elec-CC': (-12, 1), 'elec-NC': (12, 0), 'a_elec-NC': (-12, 0),
                      'tau-CC': (16, 1), 'a_tau-CC': (-16, 1),
                      'muon-CC_nu_anu': (14, 1),'muon-NC_nu_anu': (14, 0), 'elec-CC_nu_anu': (12, 1), 'elec-NC_nu_anu': (12, 0),
                      'tau-CC_nu_anu': (16, 1)
                      }
...
def make_ts_prob_hists(pred_file, savefolder, cuts=None):
    ...
    for ts_class in ['track', 'shower']:
        make_prob_hist_class('muon-CC', mc_info, y_pred, ts_class, axes, color='C0', linestyle='-')
        make_prob_hist_class('a_muon-CC', mc_info, y_pred, ts_class, axes, color='C0', linestyle='--')
        make_prob_hist_class('muon-NC', mc_info, y_pred, ts_class, axes, color='C1', linestyle='-')
        make_prob_hist_class('a_muon-NC', mc_info, y_pred, ts_class, axes, color='C1', linestyle='--')
        make_prob_hist_class('elec-CC', mc_info, y_pred, ts_class, axes, color='C2', linestyle='-')
        make_prob_hist_class('a_elec-CC', mc_info, y_pred, ts_class, axes, color='C2', linestyle='--')
        make_prob_hist_class('elec-NC', mc_info, y_pred, ts_class, axes, color='C3', linestyle='-')
        make_prob_hist_class('a_elec-NC', mc_info, y_pred, ts_class, axes, color='C3', linestyle='--')
        make_prob_hist_class('tau-CC', mc_info, y_pred, ts_class, axes, color='C4', linestyle='-')
        make_prob_hist_class('a_tau-CC', mc_info, y_pred, ts_class, axes, color='C4', linestyle='--')
