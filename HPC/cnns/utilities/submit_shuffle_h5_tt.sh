...
# submit with 'qsub -l nodes=1:ppn=4:sl32g,walltime=01:00:00 submit_shuffle_h5_tt.sh'
...
input_filename_train=train_muon-CC_and_elec-CC_each_480_xzt.h5
input_filename_test=test_muon-CC_and_elec-CC_each_120_xzt_shuffled.h5
chunksize=32
