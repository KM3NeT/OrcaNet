...
# submit with 'qsub -l nodes=1:ppn=4,walltime=01:00:00 submit_concatenate_h5_tt.sh'
...
input_list_name_train=muon-CC_and_elec-CC_xzt_1_to_480.list # train
output_name_train=train_muon-CC_and_elec-CC_each_480_xzt.h5 # train
input_list_name_test=muon-CC_and_elec-CC_xzt_481_to_600.list # test
output_name_test=test_muon-CC_and_elec-CC_each_120_xzt.h5 # test
